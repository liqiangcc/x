...
export function createApiClient({ fetchImpl = fetch, prefix = "/api" } = {}) {
  ...
  return {
    ...
    getStrategySyncs: () => request("/strategy-syncs"),
    startStrategySync: (strategyId) => request(`/strategies/${strategyId}/sync`, { body: {}, method: "POST" }),
    rebuildStrategy: (strategyId) => request(`/strategies/${strategyId}/rebuild`, { body: {}, method: "POST" }),
    ...
    exportSession: (sessionId) => request(`/sessions/${sessionId}/export`, { body: {}, method: "POST" }),
