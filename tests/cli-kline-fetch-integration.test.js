...
test("bin/x delegates kline fetch while aggregate, retry-queue, and daily remain separate", async () => {
  ...
  assert.match(source, /async function commandKlineAggregateYearly\(/);
