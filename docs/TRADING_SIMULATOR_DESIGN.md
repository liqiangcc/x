...
```js
{
  ...
  reasons: ["年度收盘连续下降3年，本年度首次收盘突破去年最高价"],
  evidence: {},
  qualityIssues: []
}
```
...
- 能从现有 Universe 或本地 K 线交集生成“年度收盘至少连续下降 3 年、本年度今日收盘首次突破去年最高价”的默认候选快照，并展示数据覆盖范围。
...
- 候选：年度收盘至少连续下降 3 年（需要 4 个完整年度收盘点），本年度今日收盘首次突破去年最高价。
